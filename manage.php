...
<body class="bg-light">
	...
	<div class="container-fluid bg-light mt-2">
		<div class="row">
			<div class="col-lg-10 col-md-12 col-sm-12 ">
				<h3 class="mx-3 px-3 fw-bold">Manage The Gift CheckList</h3>
				<ul class="d-flex align-items-start" style="list-style-type:none; color:black">
					<li class=""><a href="registry.php">Overview</a></li>
					<li class="mx-3"><a href="manage.php">Manage Registry</a></li>
					<li class="mx-3"><a href="checklist.php">Checklist</a></li>
					<li class="mx-3"><a href="#">Track Gifts</a></li>
					<li class="mx-3"><a href="#">Settings</a></li>
				</ul>
			</div>
			<div class="col-lg-2 col-md-12 col-sm-12">
				<div class="row ">
					<img class="img-fluid rounded-circle" src="assets/img/planning/couple.jpg" alt="" style="width25vh; height:15vh;">
					<p class="card-title text-primary mt-4">Romeo and Juliet</p>
				</div>
	...
	<section class="bg-light text-danger" data-aos="fade-up">
		<h2 class="text-dark fw-bold text-center">Your Gifts Go Here</h2>
		<div class="container " data-aos="fade-up">
			<div class="row">
				<div class="col-lg-6 col-md-12 col-sm-12 text-dark border-right">
					<h2>Comment Section</h2>
					<h3>Romeo and Juliet</h3>
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti
						tempora fugit recusandae. Deserunt beatae recusandae molestiae
						nesciunt id reprehenderit voluptatum expedita necessitatibus dolorem,
						ad possimus facere, similique odio, fuga dolorum?</p>
					<form action=""></form>

				</div>
				<div class="col-lg-6 col-md-12 col-sm-12">
					<div class="row">
						<div class="col-md" data-aos="fade-up" data-aos-delay="90">
							<div class="container">
								<div class="card bg-light">
									<img class="card-img-top" src="assets/img/beddings/mirror.PNG" alt="card image top">
									<div class="card-body">
										...
										<button class="btn btn-danger mx-5">Remove</button>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md" data-aos="fade-up" data-aos-delay="90">
							<div class="container">
								<div class="card bg-light">
									<img class="card-img-top" src="assets/img/beddings/beddings.PNG" alt="card image top">
									<div class="card-body">
										<h2 class="card-title text-primary">Gift Title</h2>
										<p class="card-text text-dark">More About the gift Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae animi voluptates velit fuga possimus repellendus.</p>
										<button class="btn btn-danger mx-5">Remove</button>
									</div>
								</div>
							</div>
						...
						<div class="col-md" data-aos="fade-up" data-aos-delay="90">
							<div class="container">
								<div class="card bg-light">
									<img class="card-img-top" src="assets/img/beddings/lamp.PNG" alt="card image top">
									<div class="card-body">
										<h2 class="card-title text-primary">Gift Title</h2>
										<p class="card-text text-dark">More About the gift Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor ipsam eligendi quo minus repellat! Cupiditate.</p>
										<button class="btn btn-danger mx-5">Remove</button>
									</div>
								</div>
							</div>
						...
						<div class="col-md" data-aos="fade-up" data-aos-delay="90">
							<div class="container">
								<div class="card bg-light">
									<img class="card-img-top" src="assets/img/beddings/dressingtable.PNG" alt="card image top">
									<div class="card-body">
										<h2 class="card-title text-primary">Gift Title</h2>
										<p class="card-text text-dark">More About the gift Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam labore quos in saepe ducimus unde?</p>
										<button class="btn btn-danger mx-5">Remove</button>
									</div>
								</div>
							</div>
