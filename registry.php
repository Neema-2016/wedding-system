...
<body>
	...
	<!--Main--->
	<main>
		<div class="container-fluid" style="color:black;" data-aos="fade-up" > 
        <img src="assets/img/regifts.jpg" alt="" style="width:100%; height:80vh">
        <div class="centered ">
            <h4  class="pl-4 ml-2 text-primary animate__animated animate__tada animate__delay-2s">Your Registry</h4>
            <p style="font-family: ; font-size:24px;" class=" animate__animated animate__fadeIn animate__delay-2s">Your Love, Laughter and great company on our special day<br>
            is already more than we could wish for!<br>
            However, should you wish to honour us with gifts ,<br>
            We would be grateful as well.<br>
            
            Kindly head onto our Gift registry below to view and select our preferred gift choices.</p>
            <!-- <div class="row text-dark"> -->
            <ul class="text-dark d-flex align-items-center  animate__animated animate__fadeIn animate__delay-2s"style="list-style-type:none;font-family:Aladin; font-size:12px;">
                <li class="text-primary"><a href="#" class="text-primary">Overview</a></li>
                <li class="text-dark mx-1"><a href="checklist.php">Registry Checklist</a></li>
                <li class="text-dark mx-1"><a href="manage.php" class="text-primary">Manage Gift Registry</a></li><li class="text-dark mx-1"><a href='#'>Track Gifts</a></li>
                <li class="text-dark mx-1"><a href='#' class="text-primary">Find a couple's Registry</a></li>
            </ul>
        </div>   
    </div>
	</main>
