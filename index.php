...
<body>
	...
	<section id="hero" class="d-flex align-items-center" style="background: url('assets/img/glasses.jpg'); width: 100%!important;">
		<div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
			<h1>Merime Events</h1>
			<h2><em>Leave the hectic part of planning your big day to us..Focus on the moment.</em></h2>
		...
		<section id="services" class="services">
			<div class="container">
				...
				<div class="section-title">
					<span>Vendors</span>
					<h2>Vendors</h2>
					<p>Below are categories of trusted vendors in the country</p>
				</div>

				<div class="row">
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up">
						<div class="icon-box">
							<div class="icon"><i><img src="assets/img/pollen_flower.png"></i></div>
							<h4><a href="vendor.php?id=Florists">Florists</a></h4>
							<p>Some of the most proffesional and exquisite florists in the nation.</p>
						</div>
					</div>

					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="150">
						<div class="icon-box">
							<div class="icon"><i><img src="assets/img/clipboard.png"></i></div>
							<h4><a href="vendor.php?id=Planners">Wedding Planners</a></h4>
							<p>They will plan your event at an affordable budget.</p>
						</div>
					</div>

					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
						<div class="icon-box">
							<div class="icon"><i><img src="assets/img/rings.png"></i></div>
							<h4><a href="vendor.php?id=Jewellers">Jewellers</a></h4>
							<p>You are never really fully dressed without an ornament.Let us handle that for you.</p>
						</div>
					</div>

					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="450">
						<div class="icon-box">
							<div class="icon"><i><img src="assets/img/cake%20.png"></i></div>
							<h4><a href="vendor.php?id=Cake">Bakers</a></h4>
							<p>These vendors provide quality pastries at an affordable budget.We know no event is complete without cake ans we got you covered.</p>
						</div>
					</div>

					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="600">
						<div class="icon-box">
							<div class="icon"><i><img src="assets/img/food.png"></i></div>
							<h4><a href="vendor.php?id=Chef">Chefs</a></h4>
							<p> For finger licking delicacies that will have you coming back for more.</p>
						</div>
					</div>

					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="fade-up" data-aos-delay="750">
						<div class="icon-box">
							<div class="icon"><i><img src="assets/img/band.png"></i></div>
							<h4><a href="vendor.php?id=Bands">Wedding Bands</a></h4>
		...
		<section id="portfolio" class="portfolio">
			<div class="container">
				...
				<div class="section-title">
					<span>IDEAS</span>
					<h2>Weddind Ideas</h2>
					<p>Here is a list of trendy yet elegant designs you could implement for your big day</p>
				</div>
				...
				<div class="row" data-aos="fade-up">
					<div class="col-lg-12 d-flex justify-content-center">
						<ul id="portfolio-flters">
							...
							<li data-filter=".filter-app"> Invitation Cards</li>
							<li data-filter=".filter-card">Dresses</li>
							<li data-filter=".filter-web">Cake</li>
							<li data-filter=".filter-rings">Jewellery</li>
						</ul>
					</div>
				</div>
