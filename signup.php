	...
	<main>
		...
		<center>
			<div class="container mt-3 mb-5 mx-auto">
				<div class="row">
					<div class="col-sm-4 mb-2 cad4" data-aos="fade-up" data-aos-delay="150">
						<div class="card">
							<div class="card-body">
								<img src="assets/img/kuser%20.png">
								<p class="card-text">Sign up as couple</p>
								<a href="signcouple.php" class="btn btn-primary">Sign Up</a>
							</div>
						</div>
					</div>
					<div class="col-sm-4 mb-2 cad4" data-aos="fade-up" data-aos-delay="300">
						<div class="card">
							<div class="card-body">
								<img src="assets/img/Vendor.png">
								<p class="card-text">Sign up As Vendor</p>
								<a href="signvendor.php" class="btn btn-primary">Sign Up</a>
							</div>
						</div>
					</div>
					<div class="col-sm-4 mb-2 cad4" data-aos="fade-up" data-aos-delay="450">
						<div class="card">
							<div class="card-body">
								<img src="assets/img/add_user.png" style="height: 6rem;"><br>
								<p class="card-text">Sign up As Individual</p>
								<a href="signindividual.php" class="btn btn-primary">Sign Up</a>
							</div>
						</div>
					</div>
				</div>
