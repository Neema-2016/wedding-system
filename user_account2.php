 ...
 <!-- ======= Header ======= -->
	...
	<section id="hero" class="d-flex align-items-center" style="background: url('assets/img/glasses.jpg'); width: 100%!important;">
		<div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
			...
			<center><?php if ($role="vendor"){echo'<a href="addindividual.php" class="btn-get-started">Get Started</a>';}else{ echo'<a href="addreg.php" class="btn-get-started">Get Started</a>';}?></center>
		</div>
	</section><!-- End Hero -->
