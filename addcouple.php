...
$user=$_SESSION['id'];
$quer=mysqli_query($conn,"SELECT * FROM couples WHERE user='$user'");
if($quer){
...
if(isset($_POST['add'])){
   ...
   $event_name=mysqli_real_escape_string($conn,$_POST['event_name']);
	...
	$query=mysqli_query($conn,"iNSERT INTO couples (spouse1_name,spouse1_phone,spouse1_email,spouse1_image,spouse1_gender,spouse2_name,spouse2_phone,spouse2_email,spouse2_image,spouse2_gender,location,box,venue,venue_map,event_name,event_date,user) VALUES('$name','$phone','$email','$image','$gender','$name2','$phone2','$email2','$image2','$gender2','$location','$box','$venue','$couple_map','$event_name','$event_date','$user')");
	...
	if($query){
		   $r3=move_uploaded_file($_FILES['image']['tmp_name'],"images/couple_images/$image"); 
		   $r4=move_uploaded_file($_FILES['image2']['tmp_name'],"images/couple_images/$image2");
                  
   }if($query && $r3 && $r4){
		   echo '<script type="text/javascript">'; 
    echo 'alert("Couple Account Succesfully Added");'; 
    echo 'window.location="editcoupleprof.php";';
    echo '</script>';  
	}
					...
					<div class="row p-5">
						<div class="col-lg-6 col-md-6 mt-5 mb-5">
							...
							<div class="input-group mb-2">
								...
								<input type="text" class="form-control bg-white border-left-0 border-md" name="spouse1_name" placeholder="Enter Full Name" required>
							</div>
...
<!--
							...
							<div class="input-group mb-2">
								...
								<input type="text" class="form-control bg-white border-left-0 border-md"  name="spouse1_email" placeholder="Enter Email Adress" required>
							</div>
							...
							<div class="input-group  mb-2">
								...
								<input type="text" class="form-control bg-white border-left-0 border-md"  name="spouse1_phone" placeholder="Enter Phone Number" required>
							</div>
							...
							<select class="bg-white form-control border-left-0" name="spouse1_gender">
								...
								<label class="text-muted fw-bold">Add Photo &nbsp;<em>(helps your guests find you easily in a list of other couples)</em></label>
							<div class="input-group mb-2">
...
<!--
						...
						<div class="col-lg-6 col-md-6 mt-5 mb-5">
							...
							<div class="input-group mb-2">
								...
								<input type="text" class="form-control bg-white border-left-0 border-md" name="spouse2_name" placeholder="Enter Full Name" required>
							</div>
...
<!--
							...
							<div class="input-group mb-2">
								...
								<input type="text" class="form-control bg-white border-left-0 border-md"  name="spouse2_email" placeholder="Enter Email Adress" required>
							</div>
							...
							<div class="input-group  mb-2">
								...
								<input type="text" class="form-control bg-white border-left-0 border-md"  name="spouse2_phone" placeholder="Enter Phone Number" required>
							</div>
								<div class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text bg-white px-4 border-right-0 border-md"><i class="fas fa-user"></i></span>
							...
							<div class="input-group mb-2">
								...
								<input type="file" class="form-control bg-white border-left-0 border-md" name="image2" Required>
							</div>
						...
						<div class="mx-auto col-lg-8 col-md-8 col-sm-8">
							<div class=" form-group col-lg-10 col-md-10  input-group mb-2">
								<div class="input-group-prepend">
									...
									<input type="text" class="form-control bg-white border-left-0 border-md" name="couple_location" placeholder="Enter Central Location (Where planning is taking place)">
							</div>
						<p class="fw-bold text-center" style="font-family:fangsong;"><em>Enter date of event</em></p>
							<div class=" form-group col-lg-10 col-md-10 col-sm-12 input-group mb-2">
								<div class="input-group-prepend">
									...
									<input type="date" class="form-control bg-white border-left-0 border-md" name="wedding_date" placeholder="Enter Wedding date">
							</div>
							<div class=" form-group col-lg-10 col-md-10 col-sm-12 input-group mb-2">
								<div class="input-group-prepend">
									<span class="input-group-text px-4 bg-white border-right-0"><i class="fab fa-usps"></i></span></div>
									<input type="text" class="form-control bg-white border-left-0 border-md" name="couple_box" placeholder="Enter Central P.O Box">
							</div>
							<div class="form-group col-lg-10 col-md-10 col-sm-2 input-group mb-2">
								<div class=input-group-prepend>
									...
									<input type="text"  name="event_name" class="form-control bg-white border-left-0" placeholder="Enter type of event..eg Wedding, Bridal negotiations etc">
                         </div>
							...
							<div class=" form-group col-lg-10 col-md-10 col-sm-12 input-group mb-2">
								<div class="input-group-prepend">
									...
									<input type="text" class="form-control bg-white border-left-0 border-md" name="venue" placeholder="Enter Venue">
							</div>
							...
							<div class="form-row">
								...
								<input type="text" class="form-control bg-white border-left-0 border-md" name="latitude" placeholder="Enter Latitude">
							</div>
								<div class="form-group  col-lg-6 col-md-6  input-group mb-2">
							...
							<div class="mt-2 col-lg-10 col-md-10 mb-3"><button type="submit" name="add" class="btn btn-primary btn-block">Submit</button></div>
